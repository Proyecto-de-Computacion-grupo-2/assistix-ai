    ...
    return (
        <Container className="m-0 p-0 d-flex flex-column gap-2" fluid>
            ...
            <NavLink to='/assistant'
                     className='d-flex flex-row gap-2 mb-2 w-100 align-items-center link-offset-2 link-underline link-underline-opacity-0 fs-5 text-black mb-3'>
            ...
            <NavLink to='/settings'
                     className='d-flex flex-row gap-2 w-100 align-items-center link-offset-2 link-underline link-underline-opacity-0 fs-5 text-black mb-3'>
